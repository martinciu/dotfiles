...
assert_link "$HOME/.config/jnv/config.toml"                 "config-mocha.toml"        "jnv config.toml → config-mocha.toml"
...
assert_link "$HOME/.config/jnv/config.toml"                 "config-frappe.toml"        "jnv config.toml → config-frappe.toml"
...
assert_link "$HOME/.config/jnv/config.toml"                 "config-dracula.toml"        "jnv config.toml → config-dracula.toml"
...
assert_link "$HOME/.config/jnv/config.toml"                 "config-gruvbox.toml"        "jnv config.toml → config-gruvbox.toml"
...
assert_link "$HOME/.config/jnv/config.toml"                 "config-tokyo-night.toml"        "jnv config.toml → config-tokyo-night.toml"
...
assert_link "$HOME/.config/jnv/config.toml"                 "config-nord.toml"        "jnv config.toml → config-nord.toml"
...
assert_link "$HOME/.config/jnv/config.toml"                 "config-rose-pine.toml"        "jnv config.toml → config-rose-pine.toml"
