...
TOOLS = ["tmux","starship","lnav","btop","eza","ghostty","delta","glow","gh-dash","lazygit"]
...
<style>
  ...
  *{{box-sizing:border-box;}}
  ...
  <footer>Generated by <code>scripts/build-theme-colors.py</code>. Names are the keys/roles defined in each
     ...
     styles, ghostty <code>ansi N</code> / selection). Solarized &amp; Dracula have no lnav/btop entries
